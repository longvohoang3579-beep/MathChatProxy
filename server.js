...
const GEMINI_MODEL = "gemini-1.5-flash"; // Cập nhật model mới nhất và tốt nhất
...
  if (!question && !image) return res.status(400).json({ response: "Thiếu đề toán hoặc ảnh." });
  const systemInstruction = `
...
server.timeout = 300000; // Tăng timeout lên 5 phút