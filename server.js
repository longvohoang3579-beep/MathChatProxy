...
  // ĐÃ SỬA: Tách biệt rõ ràng việc highlight và công thức LaTeX để tránh xung đột
  const systemInstruction = `
Hãy giải bài toán sau **ngắn gọn nhất có thể**, bằng tiếng Việt dễ hiểu.
- Chỉ hiển thị **bước chính** và **kết quả cuối cùng**.
- **Viết công thức toán học bằng LaTeX** (dấu $...$).
- **KHÔNG** đặt công thức LaTeX ($...$) bên trong thẻ highlight.
